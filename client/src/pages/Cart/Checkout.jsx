...
const Checkout = () => {
  const { dispatch, cart, cartActions, auth } = useReduxHooks();
  ...
  const onSubmit = async (data) => {
    const formattedEmail = currentUser?.email
      .trim()
      .replace(/\s+/g, "")
      .toLowerCase();
    ...
    const response = await apiSubmit({
      url: apis().createOrder.url,
      method: apis().createOrder.method,
      values: newOrder,
      showLoadingToast: true,
      loadingMessage: "Placing an order...",
    });
